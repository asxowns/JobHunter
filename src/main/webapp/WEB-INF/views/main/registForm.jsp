	...
	<script>
		...
		document
				...
				.addEventListener(
						...
						function(e) {
							e.preventDefault();
							var outputDivId = document
									.getElementById('outputDivId');
		...
		function checkPasswordMatch() {
			var password = document.getElementById("inputFieldPw").value;
			var confirmPassword = document.getElementById("inputFieldPwCheck").value;
			var messageSpan = document.getElementById("passwordMatchMessage");

			if (password === confirmPassword) {
				messageSpan.innerHTML = "비밀번호가 일치합니다.";
