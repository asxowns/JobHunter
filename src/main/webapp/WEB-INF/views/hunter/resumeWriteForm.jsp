				...
				<form action="/hunter/resumeWrite" method="post">
					...
					<div class="public_type">
						<span>이력서 공개여부</span><br> <input type="radio"
							name="public_type" id="public_type" value="1" >
							<label for="private">공개</label>
							 <input type="radio"
							name="public_type" id="public_type" value="0" >
					...
					<div class="education">
						...
						</select> <input type="text" name="schoolName" placeholder="학교이름"> <input
							type="text" name="major" placeholder="전공"> 졸업년도<input
							type="date" name="schoolName">
				...
				<h2>이력서 수정</h2>
					<form action="/hunter/resumeWrite" method="post">
						...
						<div class="personal_info">
							...
							<input type="text" name="tel1" placeholder="휴대폰번호"> <input
								type="text" name="tel2" placeholder="비상연락처">
						...
						<div class="education">
							학력 <br> 학력 구분 <select name="education">
								...
								<option value="대학원">대학원</option>
								<option value="검정고시">검정고시</option>
							</select> <input type="text" name="eduname" placeholder="학교이름"> <input
								type="text" name="major" placeholder="전공"> 졸업년도<input
								type="date" name="schoolName">
							<!-- 학력구분이 졸업이면 졸업년도 입력가능하게 하기 -->
							<p>학력 상태</p>
							<select name="edu_state">
								<option value="재학중">재학중</option>
								<option value="휴학">휴학</option>
						...
						<div class="coverLetter" id="resumeForm">
							<p>
								자기소개서 <br> 성장과정 : <input type="text" name="growth"
									placeholder="성장과정 기술"><br> 지원동기 : <input type="text"
									name="motive" placeholder="지원동기 기술"> <br> 성격의 장˙단점 : <input
