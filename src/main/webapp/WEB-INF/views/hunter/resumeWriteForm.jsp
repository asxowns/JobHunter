      ...
      <div>
         <form action="/hunter/resumeWrite" method="post">
            ...
            <div class="personal_info">
               ...
               <input type="text" name="emergency_contact" placeholder="비상연락처"> 
            ...
            <div class="education">
               ...
               <select name="education">
                  ...
                  <input type="text" name="schoolName" placeholder="학교이름"> 
                  <input type="text" name="major" placeholder="전공"> 
                  <input type="date" name="schoolName" placeholder="졸업년도">
            ...
            <div class="career">
               <p>경력
                  ...
                  <input type="text" name="industry" placeholder="산업군"><br>
            ...
            <div class="certificate"> 
               <p>자격증
                  <input type="text" name="certificate" placeholder="자격증 명"> 
                  <input type="text" name="issuer" placeholder="발급처"> 
                  취득일 <input type="date" name="optaindate">
               </p>
            </div>
            <div class="coverLetter"  id="resumeForm">
               <p>
                  자기소개서 <br>
                  성장과정 : <input type="text" name="growth" placeholder="성장과정 기술"><br>
                  지원동기 : <input type="text" name="ji" placeholder="지원동기 기술"> <br>
                  성격의 장˙단점 : <input type="text" name="jang" placeholder="성격의 장˙단점 기술 "> 
               </p>
            </div>
