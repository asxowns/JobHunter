		...
		<div id="post-list-table">
			<c:forEach var="offer" items="${offList}">
				<div class="offer-list">
					...
					<div class="btn">
						<input type="button" class="ok" value="수정"> <input
							type="button" class="no" value="거절">
					</div>
					...
					<div class="details" style="display: none;">
						<div class="managetelordeadline">
							<input type="text" readonly value="${offer.managetel}"> <input
								type="text" readonly value="${offer.deadline}">
						</div>
					</div>
				</div>
